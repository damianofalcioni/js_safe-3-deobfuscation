//payload beautify and analysis 2
function x(y) {
...
/*
notes:
The y parameter of x must be a string of 2 characters. The only characters valids are 0-9a-zA-Z_@!?- (from the open_safe function).
We have to brute force the x function testing all the possible combinations of y.
In order to speed up the process the code can be optimized moving lot of operations outside the x
*/
